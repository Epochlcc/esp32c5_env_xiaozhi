...
protected:
    ...
    lv_obj_t* env_panel_ = nullptr;
    lv_obj_t* env_temp_label_ = nullptr;
    lv_obj_t* env_humidity_label_ = nullptr;
    lv_obj_t* env_iaq_label_ = nullptr;
    lv_obj_t* env_co2_label_ = nullptr;
